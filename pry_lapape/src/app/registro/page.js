      ...
      <section className="min-h-[80vh] grid lg:grid-cols-2 bg-white">
        ...
        <div className="flex items-center justify-center p-8 lg:p-12 bg-gradient-to-br from-[#FFF9E6] to-[#FFFDEF]">
          <div className="max-w-md w-full space-y-8">
            ...
            {/* Banner de error (solo si hay mensaje) */}
            {errorMsg && (
            ...
            <form className="space-y-6" onSubmit={onSubmit}>
              <div className="space-y-5">
                ...
                {/* Select de rol (opcional). Si no lo usas, se manda CLIENTE por defecto */}
                <label className="flex flex-col gap-2 w-full">
                  <span className="text-sm text-[#666]">Rol</span>
                  <select
                    className="h-12 rounded-xl px-3 outline-none border-2 focus:ring-4"
                  ...
                  >
                    <option value="">(Por defecto: Cliente)</option>
              ...
              <label className="flex items-start gap-3 text-sm text-[#333333] cursor-pointer group">
                ...
                <span>
                  Acepto los <a href="#" className="text-[#4A90E2] font-semibold hover:underline">términos y condiciones</a> y la <a href="#" className="text-[#4A90E2] font-semibold hover:underline">política de privacidad</a>
                </span>
              </label>

              <div className="space-y-4">
                <PrimaryButton type="submit" className="w-full flex items-center justify-center gap-3 py-4 text-lg font-bold" disabled={loading}>
                  <UserPlus size={20} />
        ...
        {/* Lado derecho - Beneficios del registro (idéntico a tu diseño) */}
